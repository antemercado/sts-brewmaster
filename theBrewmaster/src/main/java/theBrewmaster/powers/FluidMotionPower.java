...
public class FluidMotionPower extends AbstractPower{
    ...
    public void atEndOfTurnPreEndTurnCards(boolean isPlayer){
        ...
        //     return;
        // }
        float intoxication = player.getPower(IntoxicationPower.POWER_ID).amount;
        flash();
        addToBot(new GainBlockAction(player, player, (int)Math.ceil(intoxication * this.amount / 10)));
    }
