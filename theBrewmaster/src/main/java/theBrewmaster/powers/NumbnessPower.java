...
public class NumbnessPower extends AbstractPower{
    public AbstractCreature source;

    public static final String POWER_ID = BrewmasterMod.makeID("NumbnessPower");
    ...
    public NumbnessPower(final AbstractCreature owner, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public void atEndOfTurn(boolean isPlayer) {
        ...
        for (AbstractPower po : owner.powers){
            if (po.type.equals(PowerType.DEBUFF)){
                po.flash();
                addToTop(new ReducePowerAction(this.owner, this.owner, po, this.amount));
            }
        }
    }
