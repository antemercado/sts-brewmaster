...
public class DistilleryPower extends AbstractPower{
    public AbstractCreature source;

    public static final String POWER_ID = BrewmasterMod.makeID("DistilleryPower");
    ...
    public DistilleryPower(final AbstractCreature owner, final int amount) {
        name = NAME;
        ID = POWER_ID;
