...
public class DrenchedPower extends AbstractPower{
    ...
    public int onAttacked(DamageInfo info, int damageAmount) {
        addToBot(new RemoveSpecificPowerAction(owner, info.owner, this));
        addToBot(new DamageAllEnemiesAction(AbstractDungeon.player, this.amount, CustomDamageTypes.DRENCHED, AttackEffect.FIRE));
        return damageAmount;
    }
