...
public class BelligerentRoar extends AbstractBrewmasterCard {
    ...
    public static final String IMG = makeDefaultCardPath(BelligerentRoar.class.getSimpleName(), TYPE);
